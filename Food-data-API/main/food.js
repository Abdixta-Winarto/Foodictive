...
},
{
  ...
  howtocook: 'Step 1 Heat the oil in a large frying pan or wok and boil a small saucepan of water. Fry the tofu for a few mins each side until brown and crispy, then transfer to a plate. Add the potatoes to the frying pan and cook for a few mins until they are warmed through and starting to crisp, then tip onto the same plate and set aside to cool; Step 2 Add the eggs to the boiling water and cook for 7 mins, then plunge them straight into cold water. Fill the saucepan with fresh water, bring to the boil and add the beans. Cook for 2-3 mins until just tender. Drain and run under cold water until cool; Step 3 To make the peanut dressing, put the peanut butter and kecap manis in a bowl and mash together with a fork until smooth and combined. Whisk in the remaining ingredients; Step 4 Put the tofu, potatoes, beans, cabbage, cucumber, beansprouts, carrot and coriander in a large bowl or arrange on a platter. Drizzle over half the dressing, reserving the rest for people to help themselves. Break the prawn crackers in your hands and scatter over. Peel and quarter the eggs, and serve on top with the crispy onions. Toss together just before serving. ',
},
{
  id: '',
  name: '',
