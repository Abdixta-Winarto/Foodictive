...
},
{
  ...
  ingredients: '1 Tbsp cooking oil, 4 bay leaves (daun salam), 4 pieces of bone-in chicken thighs/drumstick, 1 ½ lb canned green jack fruit, ½ cup red beans (soaked for 4 hours) optional, 6 cups coconut milk, 1 black tea tea bag, 50 gr Palm sugar or dark brown sugar, Pinch of salt, 4 hard-boiled eggs, 4 garlic cloves peeled and finely chopped, 1 tsp coriander seeds, 8 candlenuts closest substitution is macademia nuts, or 10 blanched almonds, chopped, 3 shallots, 1 inch ginger, 2 inch galangal',
  howtocook: 'First, Place all the ingredients for ground spices in a food processor and process into a paste. Add a little bit of water if needed to get it going. Second, Preheat a large pot or dutch oven with cooking oil. Add the ground spices and bay leaves and saute until fragrant, about 5 minutes. Add the chicken, jackfruit, red beans and stir to mix. Pour in the coconut milk, tea bag, salt, and brown sugar. Bring it to a boil and then lower the heat and cover to let it cook for the next 1 hour. Give it a stir every now and then. Uncover and then add in the hard-boiled eggs and let it cook again for another hour or so until the jackfruit is soft to the point where you can easily shred it with a fork. The beans should be soft and chicken meat is almost falling off the bones. The liquid should be almost all absorbed at this point and the eggs are nicely tinted with brown color. Last, Serve with rice and sambal on the side.',
},
{
  id: 'nasipindang',
  name: 'Nasi Pindang',
  ...
  howtocook: 'First, In a frying pan, heat the oil, then add the lemon grass, bay leaf and lime leaves, stir briefly, then add the ground spices, stir-fry until fragrant. Second, Add the pieces of meat, then stir until the spices are evenly distributed. Add boiled water, bring to a boil, then reduce heat and cover the pot. Cook until the meat is tender. Third, Add salt, brown sugar, tamarind water and Bango Sweet Soy Sauce, stir until the spices are absorbed. Add the melinjo leaves and cook until the melinjo leaves are cooked, remove from heat. Fourth, Serve.',
},
{
  id: 'sateayam',
  name: 'Sate Ayam',
  ...
  howtocook: 'First, To make the peanut sauce, whisk together peanut butter, soy sauce, lime juice, brown sugar, chili garlic sauce and ginger in a small bowl. Whisk in 2-3 tablespoons water until desired consistency is reached; set aside. Second, In a medium bowl, combine coconut milk, soy sauce, curry powder, turmeric, garlic, ginger, brown sugar and fish sauce. Third, In a gallon size Ziploc bag or large bowl, combine chicken and coconut milk mixture; marinate for at least 2 hours to overnight, turning the bag occasionally. Fourth, Drain the chicken from the marinade, discarding the marinade. Fifth, Preheat grill to medium high heat. Thread chicken onto skewers. Brush with canola oil; season with salt and pepper, to taste. Sixth, Add skewers to grill, and cook, turning occasionally, until the chicken is completely cooked through, reaching an internal temperature of 165 degrees F, about 12-15 minutes. Last, Serve immediately with peanut sauce.',
},
{
  id: 'bakso',
  name: 'Bakso',
