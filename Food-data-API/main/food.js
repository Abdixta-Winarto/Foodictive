...
},
{
  ...
  third: 'Add the chicken, jackfruit, red beans and stir to mix. Pour in the coconut milk, tea bag, salt, and brown sugar. Bring it to a boil and then lower the heat and cover to let it cook for the next 1 hour. Give it a stir every now and then. Uncover and then add in the hard-boiled eggs and let it cook again for another hour or so until the jackfruit is soft to the point where you can easily shred it with a fork. The beans should be soft and chicken meat is almost falling off the bones. The liquid should be almost all absorbed at this point and the eggs are nicely tinted with brown color.',
  fourth: 'Last, Serve with rice and sambal on the side.',
  fifth: '',
  sixth: '',
  seventh: '',
  eighth: '',
...
},
{
  ...
  sixth: 'Step 8 Divide the carrot slices and spinach into three portions and put in the bowls next to the noodles.',
  seventh: 'Step 9 Ladle the hot soup and meatballs directly into the bowls',
  eighth: 'Step 10 Top each bowl with crisp-fried shallots and split hard-boiled eggs, if using.',
  ninth: '',
},
{
  id: 'gadogadosalad',
...
},
{
  ...
  howtocook: 'Step 1 Create the Brown Sauce, In a saucepan, bring water, coconut sugar, salt and garlic to a boil. Thicken with tapioca flour mixture, stir until mixed. Remove from heat and set aside; Cook bambo shoot with water and 1 tbsp sugar until boiled, drain. Stir fry garlic until fragrant, add shrimp, bamboo shoot, ground dried shrimp, oyster sauce, kecap manis, white pepper and salt. Add broth, cook until water evaporates; Step 3 Place 2- 3 tbsp filling on the wrapper. Fold over the corner that faces away from us. Brush brown sauce onto this corner for gluing. Fold over the left-facing and right-facing corners. Roll the lumpia toward us, onto the remaining corner of the wrapper. Examine the wrapper to ensure that it is fully sealed. Do until all filling and wrappers done; Step 4 Deep fry until golden brown.',
  first: '',
  second: '',
  third: '',
  fourth: '',
...
},
{
  ...
  howtocook: 'Step 1 Chop the spice paste ingredients and then blend it in a food processor until fine; Step 2 Heat the oil in a stew pot, add the spice paste, cinnamon, cloves, star anise, and cardamom and stir-fry until aromatic. Add the beef and the pounded lemongrass and stir for 1 minute. Add the coconut milk, tamarind juice, water, and simmer on medium heat, stirring frequently until the meat is almost cooked. Add the kaffir lime leaves, kerisik (toasted coconut), sugar or palm sugar, stirring to blend well with the meat; Step 3 Lower the heat to low, cover the lid, and simmer for 1 to 1½ hours or until the meat is really tender and the gravy has dried up. Add more salt and sugar to taste. Serve immediately with steamed rice and save some for overnight.',
  first: '',
  second: '',
  third: '',
  fourth: '',
